...
![image-20221218193111172](.\assets\image-20221218193111172.png)
...
`BIOS`（Basic Input Output System，基本输入输出系统）诞生于1975年的CP/M计算机。`UEFI`，全称Unified Extensible Firmware Interface，即“统一的可扩展固件接口”，是一种详细描述全新类型接口的标准，这种接口用于操作系统自动从预启动的操作环境，加载到一种操作系统上。是适用于电脑的标准固件接口，旨在代替`BIOS`(基本输入/输出系统)。
...
![传统bios开机流程](http://www.dnxtc.net/d/file/zixun/zhuangjijiaocheng/2022-03-24/ba4d428e4c14afd8784af475efd9061f.png)

![uefi开机流程](http://www.dnxtc.net/d/file/zixun/zhuangjijiaocheng/2022-03-24/3a0db76506b2aabec916f2ad23fa789e.png)
